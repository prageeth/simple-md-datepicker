...
const defaults = (globalOverride) => (Object.assign({
...
let globalOverrideOptions = {};

class DateTimePicker extends Events {
  constructor(options = {}) {
    super();

    let defaultOptions = defaults(globalOverrideOptions);

    const styles = Object.assign(defaultOptions.styles, options.styles);
...
DateTimePicker.setDefaults = (defaults) => {
